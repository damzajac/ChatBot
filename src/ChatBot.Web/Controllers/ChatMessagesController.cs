...
using ChatBot.Application.UseCases.Commands.CreateChatMessage;
using ChatBot.Application.UseCases.Commands.UpdateChatMessage;
using ChatBot.Application.UseCases.Queries.GetChatMessages;
using MediatR;
...
namespace ChatBot.Web.Controllers
{
    ...
    public class ChatMessagesController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task Create([FromBody] CreateChatMessageCommand command, CancellationToken cancellationToken)
        {
